        ...
        <div className="px-5 py-7 sm:px-8 md:py-10">
          ...
          {mode === "choose" ? (
            <div className="space-y-2.5">
              ...
              >
                <svg className="w-5 h-5 shrink-0 opacity-60" viewBox="0 0 24 24">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 border border-gray-200 hover:border-gray-300 hover:bg-gray-50 disabled:opacity-50 rounded-xl px-4 py-3 transition-all active:scale-[0.99]"
              >
                <svg className="w-5 h-5 shrink-0 opacity-60" viewBox="0 0 24 24" fill="#06C755" xmlns="http://www.w3.org/2000/svg">
              ...
              >
                ...
                <span className="text-sm font-semibold text-gray-700">เข้าสู่ระบบด้วยอีเมล</span>
              </button>
